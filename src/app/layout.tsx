...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Tiendas online de alta velocidad, sin comisiones por venta, preparadas para escalar y convertir al máximo.",
  ...
  twitter: {
    ...
    title: "GiorgIT | Plataformas Ecommerce de Alto Rendimiento",
    description:
      "Tiendas online a medida con tecnología moderna, sin comisiones por venta.",
  },
};
